...
/*@
  ...
  fixpoint list<pair<t, bool> > vector_erase_all_fp<t>(list<pair<t, bool> >
  vector, list<int> indices) { switch(indices) { case nil: return vector; case
  cons(h,t): return vector_erase_fp(vector_erase_all_fp(vector, t), h);
    }
  }
