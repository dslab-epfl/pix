...
// Use only a single map when replaying for performance analysis
// as the tool does not support multiple data structure instances
// yet.
// TODO: get rid of this simplification
#ifdef REPLAY
